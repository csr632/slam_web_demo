...
class DispNetS(nn.Module):
    ...
    def forward(self, x):
        ...
        out_upconv8 = crop_like(self.upconv8(out_conv8), out_conv7)
        concat8 = torch.cat((out_upconv8, out_conv7), 1)
        out_iconv8 = self.iconv8(concat8)

        out_upconv7 = crop_like(self.upconv7(out_iconv8), out_conv6)
