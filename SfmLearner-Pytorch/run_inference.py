...
def main():
    ...
    for file in tqdm(test_files):
        ...
        if args.output_disp:
            ...
            imsave(output_dir/'{}{}'.format(file.namebase,file.ext), disp)
        if args.output_depth:
            depth = 1/output
            np.save(output_dir/'{}{}'.format(file.namebase, '.npy'), depth)
            depth = (255*tensor2array(depth, max_value=10, colormap='rainbow')).astype(np.uint8)
            imsave(output_dir/'{}{}'.format(file.namebase,file.ext), depth)
